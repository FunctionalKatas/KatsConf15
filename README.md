...
<div class="storify"><iframe src="//storify.com/FunctionalKats/kats-conf-15/embed?header=false&template=grid" width="100%" height="750" frameborder="no" allowtransparency="true"></iframe><script src="//storify.com/FunctionalKats/kats-conf-15.js?header=false&template=grid"></script><noscript></noscript></div>
